  ...
  return (
    <article id="printable-sales-order" className="bg-white" style={{ fontFamily: SO.font, color: SO.text }}>
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="w-[140px] h-[68px] flex items-center justify-center overflow-hidden">
            {logo ? (
              ...
              <div className="leading-none">
                ...
                <p className="text-[11px] font-bold tracking-[0.28em] uppercase" style={{ color: SO.navy }}>Mineração</p>
              </div>
            )}
          </div>
          <div className="text-right">
            ...
            <div className="mt-2 inline-flex items-center border-2 overflow-hidden" style={{ borderColor: SO.navy }}>
              <span className="px-3 py-1 text-xs font-black text-white" style={{ background: SO.navy }}>Nº</span>
              <span className="px-4 py-1 text-[13px] font-black min-w-[140px] text-left">{order.reference}</span>
            </div>
          </div>
        </div>
        <div className="mt-4 grid grid-cols-4 gap-2 text-center text-[11px] font-bold uppercase tracking-wide" style={{ color: SO.navy }}>
      ...
      <section className="mx-7 mb-3">
        <div className="px-3 py-1.5 text-[11px] font-black tracking-widest text-white uppercase" style={{ background: SO.navy }}>Dados do cliente</div>
        <div className="border border-t-0 px-3 py-2 grid grid-cols-2 gap-x-6 gap-y-1.5 text-xs" style={{ borderColor: SO.border }}>
      ...
      <section className="mx-7 mb-3">
        <div className="px-3 py-1.5 text-[11px] font-black tracking-widest text-white uppercase" style={{ background: SO.navy }}>Dados do pedido</div>
        <div className="border border-t-0 grid grid-cols-4 text-xs" style={{ borderColor: SO.border }}>
          <div className="px-3 py-2 border-r" style={{ borderColor: SO.border }}>
            <p className="font-black uppercase text-[11px]" style={{ color: SO.muted }}>Data do pedido</p>
            <p className="font-bold">{formatDate(order.date)}</p>
          </div>
          <div className="px-3 py-2 border-r" style={{ borderColor: SO.border }}>
            <p className="font-black uppercase text-[11px]" style={{ color: SO.muted }}>Previsão de entrega</p>
            <p className="font-bold">{formatDate(order.deliveryDate)}</p>
          </div>
          <div className="px-3 py-2 border-r" style={{ borderColor: SO.border }}>
            <p className="font-black uppercase text-[11px]" style={{ color: SO.muted }}>Cond. de pagamento</p>
            <p className="font-bold">{dash(order.paymentMethod)}</p>
          </div>
          <div className="px-3 py-2">
            <p className="font-black uppercase text-[11px]" style={{ color: SO.muted }}>Vendedor</p>
      ...
      <section className="mx-7 mb-3 grid grid-cols-2 gap-3">
        <div className="border p-3 text-xs" style={{ borderColor: SO.border }}>
          <p className="font-black uppercase text-[11px] tracking-widest" style={{ color: SO.muted }}>Produto</p>
      ...
      <section className="mx-7 mb-4 grid grid-cols-2 gap-3">
        <div>
          <div className="px-3 py-1.5 text-[11px] font-black tracking-widest text-white uppercase" style={{ background: SO.navy }}>Observações</div>
          <div className="border border-t-0 min-h-[72px] px-3 py-2 text-xs" style={{ borderColor: SO.border }}>{order.notes || ''}</div>
        </div>
        <div className="border px-3 py-3 text-center text-xs" style={{ borderColor: SO.border }}>
      ...
      >
        ...
        <div className="text-xs text-right" style={{ color: SO.muted }}>
