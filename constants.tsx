...
export const DEFAULT_FISCAL_CONFIG: FiscalConfig = {
  ...
  telefoneEmitente: '(93) 3522-8000',
  emailEmitente: 'fiscal@calcarioflow.com.br',
  logradouroEmitente: 'Rodovia Mineral BR-163, Km 42',
  numeroEmitente: 'S/N',
  complementoEmitente: 'Galpão Industrial 01',
  bairroEmitente: 'Distrito Industrial',
  cidadeEmitente: 'Santarém',
  ufEmitente: 'PA',
  cepEmitente: '68000-000',
  ibgeEmitente: '1506807',
